...
public:
    struct Parameter {
        Parameter(const std::string& name, const std::vector<std::string>& options = std::vector<std::string>())
            : name(name), value(""), defaultValue(""), hasDefault(false), options(options) {}
        Parameter(const std::string& name, const std::string& defaultValue,
                  const std::vector<std::string>& options = std::vector<std::string>())
            : name(name), value(defaultValue), defaultValue(defaultValue), hasDefault(true), options(options) {}
...
protected:
    ...
    inline void setDescription(const std::string& newDescription) noexcept { description = newDescription; }
    ...
    inline std::string getParameter(const std::string& name) const noexcept { return getParameter<std::string>(name); }
